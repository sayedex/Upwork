...
interface IERC721A {
     ...
     * - `tokenId` token m ust exist and be owned by `from`.
     * - If the caller is not `from`, it must behave been allowed to move
...
contract ApesUnshaved is IERC721A, IERC721Receiver{ 
